...
Pod::Spec.new do |s|
  s.name             = 'ZSButton'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ZSButton.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/shize/ZSButton'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'shize' => 'shize@youmi.net' }
  s.source           = { :git => 'https://github.com/shize/ZSButton.git', :tag => s.version.to_s }
